...
library(readODS) #Carregar panilha no formato .ODS (OpenOffice)
library(factoextra) #Produzir de gráficos (Dendograma e K-média)
...
Base_dados_zoomorfo=read_ods("dados_reconhecimento.ods")#importar base de dados
...
#DefiniÃ§Ã£o de Escala Quadrúpedes
